...
(nno- "<leader>tt" (fn [] (jump->test :edit) "Jump to test"))
(nno- "<leader>tv" (fn [] (jump->test :vsplit) "Jump to test in a vsplit"))
(nno- "<leader>ts" (fn [] (jump->test :split) "Jump to test in a split"))
